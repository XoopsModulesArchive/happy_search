<?php
// $Id: system.php,v 1.3 2007/11/02 12:54:09 ohwada Exp $
...
//=========================================================
// Happy Search
// This file is modified from suin's search
//=========================================================

// $Id: system.php,v 1.0 2005/02/02 06:05:00 suin 
// FILE		::	system.php
// AUTHOR	::	suin <sim@suin.jp>
// WEB		::	AmethystBlue <http://www.suin.jp>
//

function b_search_system($queryarray, $andor, $limit, $offset, $userid)
{
	global $xoopsDB;
