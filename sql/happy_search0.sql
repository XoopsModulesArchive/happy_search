# $Id: happy_search0.sql,v 1.1 2007/07/04 11:07:48 ohwada Exp $
...
#
# Table structure for table `happy_search0_config`
# modify from system `config`
#

CREATE TABLE happy_search0_config (
...
#
# Table structure for table `happy_search0_module`
# porting from suin's search `search`
#

# CREATE TABLE `happy_search0_module` (
...
#
# Table structure for table `happy_search0_xoogle`
# not use
# for lower compatibility
#

CREATE TABLE `happy_search0_xoogle` (
